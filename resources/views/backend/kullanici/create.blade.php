            ...
            <div class="col-md-12 col-sm-4 col-xs-12">
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form action="{{route('kullanici.store')}}" method="POST" id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Ad <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="name" name="kullanici_ad" value="{{old('kullanici_ad')}}" placeholder="Ad" required="required" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="lastname" name="kullanici_soyad" value="{{old('kullanici_soyad')}}" placeholder="Soyad" required="required" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="email" name="kullanici_mail" placeholder="Mail" value="{{old('kullanici_mail')}}"  required="required" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="password" name="kullanici_password" value="{{old('kullanici_password')}}" placeholder="Şifre" required="required" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="kullanici_tc" value="{{old('kullanici_tc')}}" placeholder="TC" required="required" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="tel" id="gsm" name="kullanici_gsm" value="{{old('kullanici_gsm')}}" placeholder="GSM" required="required" class="form-control col-md-7 col-xs-12" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="kullanici_il" value="{{old('kullanici_il')}}" placeholder="İl" required="required" class="form-control col-md-7 col-xs-12" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="kullanici_ilce" value="{{old('kullanici_ilce')}}" placeholder="İlçe" required="required" class="form-control col-md-7 col-xs-12" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="kullanici_adres" value="{{old('kullanici_adres')}}" placeholder="Adres" required="required" class="form-control col-md-7 col-xs-12" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="kullanici_unvan" value="{{old('kullanici_unvan')}}" placeholder="Ünvan" required="required" class="form-control col-md-7 col-xs-12" >
                                </div>
                            </div>
