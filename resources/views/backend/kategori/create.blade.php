        ...
        <div class="row">
            <div class="col-md-12 col-sm-4 col-xs-12">
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br/>
                        <form action="{{route('kategori.store')}}" method="POST" id="demo-form2" data-parsley-validate
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="first-name" name="kategori_ad"
                                           placeholder="Kategori adını giriniz" required="required" value="{{old('kategori_ad')}}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="number" id="first-name" name="kategori_sira" placeholder="Sıra giriniz" value="{{old('kategori_sira')}}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select id="heard" class="form-control" name="kategori_durum" required>
                                        <option @if(old('kategori_durum')==1) selected @endif value="1">Aktif</option>
                                        <option @if(old('kategori_durum')==0) selected @endif value="0">Pasif</option>
                                    </select>
                                </div>
                            </div>
